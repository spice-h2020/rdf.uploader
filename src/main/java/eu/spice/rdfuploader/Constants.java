...
public class Constants {
	...
	public class RDFJobsConstants {

		public final static String PROCESSING = "PROCESSING", STATUS = "status", QUERY = "query",
				CONSTRUCT = "CONSTRUCT", PENDING = "PENDING", DATASET = "dataset",
